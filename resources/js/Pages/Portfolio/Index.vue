<template>
    ...
    <div class="bg-white">
        ...
        <div class=" grid mx-8 md:mx-32 mb-16 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:mx-64 2xl:mx-96 gap-y-8 2xl:gap-12 content-center ">
            <!--    Adopet-->
            ...
            <a href="https://vin-cadou.ro/" class="z-10  shadow-lg bg-white mx-4 ">
                ...
                <div class="flex justify-center mt-2">
                    <p class="text-xl text-center mx-2" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
                        Dream Wine Special
                    </p>
                </div>
